...
use \Phake;
use Spipu\Html2Pdf\Css\RuleParser;
...
class RuleParserTest extends \PHPUnit_Framework_TestCase
{
    public function testParse()
    {
        ...
        $parser1 = Phake::mock('Spipu\Html2Pdf\Css\Selector\SelectorParserInterface');
        ...
        $parser2 = Phake::mock('Spipu\Html2Pdf\Css\Selector\SelectorParserInterface');
        ...
        $parser3 = Phake::mock('Spipu\Html2Pdf\Css\Selector\SelectorParserInterface');
