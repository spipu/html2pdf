...
class HTML2PDF
{
		...
		protected $_debugType        = 'normal';    // debug stop time
		 ...
		 * @return HTML2PDF $this
		 */
		public function setModeDebug($type='normal')
		{
				$time = microtime(true);
				...
				$this->_debugType	   = (in_array($type,array('normal','ajax')))?$type:'normal';
		...
		public function Output($name = '', $dest = false)
		{
				...
				if ($this->_debugActif) {
						...
						$this->pdf->Close();
						if ($this->_debugType == 'normal') exit;
				}
